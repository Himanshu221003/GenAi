...
const Home = () => {
    ...
    // Naya state file name dikhane ke liye
    ...
    // File select hone par name update karne ke liye function
            ...
            <div className='interview-card'>
                        ...
                        <div className='upload-section'>
                            ...
                            <label className={`dropzone ${selectedFileName ? 'dropzone--selected' : ''}`} htmlFor='resume'>
                                <span className='dropzone__icon'>
                                    {selectedFileName ? (
                                        // Success Icon jab file select ho jaye
                                ...
                                <p className='dropzone__subtitle'>
                                    {selectedFileName ? "File ready for analysis" : "PDF or DOCX (Max 5MB)"}
                                </p>
                                <input
                                    ref={resumeInputRef}
                                    hidden
                ...
                <div className='interview-card__footer'>
                    ...
                    <button
                        ...
                        disabled={!jobDescription || (!selectedFileName && !selfDescription)}
                    >
